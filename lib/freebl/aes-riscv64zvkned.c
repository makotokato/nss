...
static vuint32m1_t
vaeskf1_vi_u32m1(vuint32m1_t vs2, int uimm)
{
    vuint32m1_t vd;
...
static vuint32m1_t
vaeskf2_vi_u32m1(vuint32m1_t vd, vuint32m1_t vs2, int uimm)
{
...
riscv64zvkn_key_expansion_128(AESContext *cx, const unsigned char *key)
{
    ...
    k2 = vaeskf1_vi_u32m1(k1, 1);
    k3 = vaeskf1_vi_u32m1(k2, 2);
    k4 = vaeskf1_vi_u32m1(k3, 3);
    k5 = vaeskf1_vi_u32m1(k4, 4);
    k6 = vaeskf1_vi_u32m1(k5, 5);
    k7 = vaeskf1_vi_u32m1(k6, 6);
    k8 = vaeskf1_vi_u32m1(k7, 7);
    k9 = vaeskf1_vi_u32m1(k8, 8);
    k10 = vaeskf1_vi_u32m1(k9, 9);
    k11 = vaeskf1_vi_u32m1(k10, 10);
...
riscv64zvkn_key_expansion_256(AESContext *cx, const unsigned char *key)
{
    ...
    k3 = vaeskf2_vi_u32m1(k1, k2, 2);
    k4 = vaeskf2_vi_u32m1(k2, k3, 3);
    k5 = vaeskf2_vi_u32m1(k3, k4, 4);
    k6 = vaeskf2_vi_u32m1(k4, k5, 5);
    k7 = vaeskf2_vi_u32m1(k5, k6, 6);
    k8 = vaeskf2_vi_u32m1(k6, k7, 7);
    k9 = vaeskf2_vi_u32m1(k7, k8, 8);
    k10 = vaeskf2_vi_u32m1(k8, k9, 9);
    k11 = vaeskf2_vi_u32m1(k9, k10, 10);
    k12 = vaeskf2_vi_u32m1(k10, k11, 11);
    k13 = vaeskf2_vi_u32m1(k11, k12, 12);
    k14 = vaeskf2_vi_u32m1(k12, k13, 13);
    k15 = vaeskf2_vi_u32m1(k13, k14, 14);
